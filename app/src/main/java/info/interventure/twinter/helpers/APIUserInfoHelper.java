...
public class APIUserInfoHelper {
	...
	public static String createJWTAccessToken() {
		...
		String payload = "{\"iss\": \"" + Constants.JVT_KEY + "\"" + ", \"exp\": " + time + "}";
		try {
			...
			SecretKeySpec secretKeySpec = new SecretKeySpec(Constants.JWT_SECRET.getBytes(),
					"HmacSHA256");
	...
	public static String getUserId(String email) {
		...
		try {
			...
			URL zoomTokenEndpoint = new URL(
					"https://api.zoom.us/v2/users/" + email + "?access_token=" + jwtAccessToken);
			HttpsURLConnection connection = (HttpsURLConnection) zoomTokenEndpoint.openConnection();
	...
	public static String createMeet(String userId) {
		String jwtAccessToken = createJWTAccessToken();
