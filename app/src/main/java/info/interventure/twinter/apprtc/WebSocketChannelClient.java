...
package info.interventure.twinter.apprtc;
...
import info.interventure.twinter.apprtc.util.AsyncHttpURLConnection;
...
public class WebSocketChannelClient {
   ...
   */
  @SuppressLint("ch.twint.walletapp.lint.enumIsInnerClass")
